            ...
            >
              <div className="w-full">
                ...
                <motion.h4
                  ...
                  className="font-normal text-zinc-300 text-base"
                >
                  ...
                  <div className="flex justify-start gap-3 mt-3 xl:gap-4 max-[600px]:gap-2 ">
                    ...
                    <motion.span
                      ...
                      className="hover:text-zinc-400"
                    >
                      <FaDigitalOcean className="w-5 h-5 text-zinc-300" />
                    </motion.span>
                  </div>
                </motion.h4>
                <motion.div
                ...
                >
                  <Link
                    ...
                    className="px-8 py-4 text-zinc-200 font-medium bg-blue-700 hover:bg-blue-800 max-[580px]:p-3"
                  >
                    Entre em contato
                  </Link>
                  <Link
